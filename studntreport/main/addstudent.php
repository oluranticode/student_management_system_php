...
<hr><center>
<div id="ac">
<span>Passport:</span><input type="file" style="height: 50px" name="file" id="file" required ><br><br>
<input type="hidden" name="memi" value="<?php echo $id; ?>" />
<span>Student ID: </span><input type="text" style="width:265px; height:30px;"  value="TD17-<?php 
...
<span>Result:</span><input type="file" style="height: 50px" name="file1" id="file1" required ><br><br>
<div >
