...
<td><?php echo $row['student_id']; ?></td>
			...
			<td><a title="Click to view the Student" href="single-viewstudent.php?id=<?php echo $row['id']; ?>"><button class="btn btn-success btn-mini" style="padding: 10px 25px;" ><i class="icon-search"  ></i> View</button> </a>
